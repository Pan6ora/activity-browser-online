...
class Client:
    ...
    def generate_parser(self):
        ...
        build.add_argument("session", nargs="?",
                           default="", help="session names")
        ...
        config = subparsers.add_parser(
            ...
            help="configure activity-browser",
        )
        config.set_defaults(func=self.api.config.update)
        config.add_argument(
            "--domain", nargs="?", default="", help="web domain to use"
        )
        return parser
